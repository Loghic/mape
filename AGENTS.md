...
scripts/     build_and_test.sh (--bench), format.sh (--check), fetch_data.py
             shim, check_abi_consistency.py, check_bench_regression.py
...
Expected: `104 checks, 0 failures` (core), `PASS` (compile-time tests), and
