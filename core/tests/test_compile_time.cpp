...
static_assert(approx(ct::exp_ct(-0.1), 0.9048374180359595, 1e-12), "exp_ct neg");
...
constexpr ct::OptionSpec kSpec = ct::make_option(OptionType::Call, 100.0, 0.20, 1.0);
constexpr double kSpecPrice = ct::price_spec(kSpec, 100.0, 0.05);
static_assert(approx(kSpecPrice, 10.4506, 1e-3), "priced from a validated spec");
