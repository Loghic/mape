...
typedef enum { MAPE_CALL = 0, MAPE_PUT = 1 } MapeOptionType;

typedef enum { MAPE_EUROPEAN = 0, MAPE_AMERICAN = 1 } MapeExercise;
 ...
 */
MAPE_API double mape_price(MapeEngine* engine, MapeModel model,
                           MapeOptionType type, MapeExercise exercise,
                           double spot, double strike, double rate, double vol,
                           double maturity, double dividend);

MAPE_API MapeStatus mape_price_ex(MapeEngine* engine, MapeModel model,
                                  MapeOptionType type, MapeExercise exercise,
...
MAPE_API double mape_delta(MapeEngine* engine, MapeOptionType type, double spot,
                           double strike, double rate, double vol,
                           double maturity, double dividend);

MAPE_API double mape_gamma(MapeEngine* engine, MapeOptionType type, double spot,
                           double strike, double rate, double vol,
                           double maturity, double dividend);

MAPE_API double mape_vega(MapeEngine* engine, MapeOptionType type, double spot,
                          double strike, double rate, double vol,
                          double maturity, double dividend);
 ...
 */
MAPE_API MapeStatus mape_price_portfolio(MapeEngine* engine, MapeModel model,
                                         MapeOptionType type,
                                         MapeExercise exercise, double spot,
...
MAPE_API double mape_price_exotic(MapeEngine* engine, MapeExotic exotic,
...
MAPE_API double mape_price_bond(MapeEngine* engine, double face, double coupon,
...
MAPE_API double mape_price_fx_forward(MapeEngine* engine, double spot,
                                      double strike, double maturity,
                                      double domestic_rate,
                                      double foreign_rate);

/* Fair forward FX rate by covered interest parity. */
MAPE_API double mape_fx_forward_rate(MapeEngine* engine, double spot,
...
MAPE_API MapeStatus mape_convergence(MapeEngine* engine, MapeModel model,
                                     MapeOptionType type, double spot,
                                     double strike, double rate, double vol,
                                     double maturity, double dividend,
